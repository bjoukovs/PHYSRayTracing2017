class Base(object):
    ...
    #Antenne par defaut : http://www.cisco.com/c/en/us/products/collateral/wireless/small-business-100-series-wireless-access-points/datasheet-c78-736450.html
    ...
    def get_gain(self,theta=0):
        #3.7 dBi, par defaut omni-directionnel
        return 2.34
